...
CREATE TABLE `advance` (
  ...
  `card_no` varchar(30) NULL DEFAULT NULL COMMENT '银行卡号',
  `card_name` varchar(50) NULL DEFAULT NULL COMMENT '开户人姓名',
  `req_amt` decimal(15,2) NULL DEFAULT NULL COMMENT '申请提现金额',
  `act_amt` decimal(15,2) NULL DEFAULT NULL COMMENT '实际提现金额',
  `fee_amt` decimal(15,2) NNULL DEFAULT NULL COMMENT '手续费',
